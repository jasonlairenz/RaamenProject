<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateRamen.aspx.cs" Inherits="RaamenProject.View.Ramen.updateRamen" %>
...
<head runat="server">
    <title></title>
    <link href="updateRamenStyle.css" rel="stylesheet" />
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <h1>Update Ramen</h1><br />
