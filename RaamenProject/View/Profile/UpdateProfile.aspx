<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateProfile.aspx.cs" Inherits="RaamenProject.View.Profile.UpdateProfile" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button CssClass="contentBtn" ID="updateBtn" runat="server" Text="Update" onclick="updateBtn_Click" /><br />
